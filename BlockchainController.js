...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    tamperChain(){
        this.app.get("/tamper", async (req, res) => {
            ...
            return res.status(200).send(JSON.stringify(tamperLog));
        });
    }
    // Validate GET endpoint to identify invalid blocks on the chain
    validateChain(){
        this.app.get("/validate", async (req, res) => {
            let errorLog= await this.blockchain.validateChain();
            return res.status(200).send(JSON.stringify(errorLog));
        });
    }
////////////////////////////////////////////////////////////////////////////////////////////////////////
